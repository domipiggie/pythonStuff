...
# 2: hány női sportoló teljesítette a teljes távot
noiTeljesTav = 0
...
# 3: kérj be egy nevet, határozd meg hogy indult-e. ha indult, mekkorat távot teljesített
...
# mindenki neve és időeredménye órában
for i in osszesEredmeny:
    print(i.nev, idoOraban(i.ido))

# 6: írassa ki a teljes távot teljesítő, férfi sportolók átlagos idejét órában
idokSzama = 0
...
print(round(osszesitettIdokOraban/idokSzama, 3))